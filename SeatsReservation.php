...
<html>
    ...
    <div class="image">
        ...
        <div class="content">
            ...
            <div class="right">
                <div class="container">
                    <button id="31" onclick="Seats(31)" value="A6" class="seats"><?php echo $key[5]?></button>
                    <button id="32" onclick="Seats(32)" value="A7" class="seats"><?php echo $key[6]?></button>
                    <button id="33" onclick="Seats(33)" value="A8" class="seats"><?php echo $key[7]?></button>
                    <button id="34" onclick="Seats(34)" value="A9" class="seats"><?php echo $key[8]?></button>
                    <button id="35" onclick="Seats(35)" value="A10" class="seats"><?php echo $key[9]?></button>
                </div>
                <div class="container">
